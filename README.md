...
1. **Weather Screen:** Search for cities and view current weather metrics.
2. **Create Report & Camera Screen:** Capture a photo using the custom CameraX view and add personal field notes to the weather data.
3. **Saved Reports Screen:** Scroll through a persistent list of all historically saved weather reports, complete with image previews and compression metadata.
